      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 service-column">
            ...
            <div class="service-text">
              <h6 class="text-uppercase"><a href="tel:+33102030405">01 02 03 04 05</a></h6>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <?php foreach($footerType as $typeObject): ?>
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
<!--Ici on vient récupérer dynamiquement grâce à ce foreach tous les noms des catégories 
1- on vient chercher dans la variable qui contient notre méthode qui contient notre objet que l'on veut parcourir 
